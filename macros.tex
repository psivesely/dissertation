...
% FINAL PATCH (compile-tested + visually inspected)
% Requires:
%   \usepackage{etoolbox}
%   \usepackage{setspace}
% Put after those packages are loaded.

% --- 1) All array-based structures: make row spacing single-ish globally ---
% This covers:
%   array, matrix, bmatrix, pmatrix, vmatrix, Vmatrix, cases,
%   tabular, tabular*, longtable
\renewcommand{\arraystretch}{0.60}

% --- 2) Table floats: single-space surrounding table text/caption context ---
\BeforeBeginEnvironment{table}{\begingroup\singlespacing}
\AfterEndEnvironment{table}{\endgroup}

% --- 3) longtable is not inside a table float, so wrap it explicitly ---
\BeforeBeginEnvironment{longtable}{\begingroup\singlespacing}
\AfterEndEnvironment{longtable}{\endgroup}

% --- 4) Displayed equations: single-spaced internally, no extra blank space above/below ---
\newcommand{\tightdisplaymath}{%
  \begingroup
  \singlespacing
...
\newcommand{\tightdisplaymathend}{\endgroup}

\BeforeBeginEnvironment{equation}{\tightdisplaymath}
\AfterEndEnvironment{equation}{\tightdisplaymathend}
\BeforeBeginEnvironment{equation*}{\tightdisplaymath}
\AfterEndEnvironment{equation*}{\tightdisplaymathend}

\BeforeBeginEnvironment{align}{\tightdisplaymath}
\AfterEndEnvironment{align}{\tightdisplaymathend}
\BeforeBeginEnvironment{align*}{\tightdisplaymath}
\AfterEndEnvironment{align*}{\tightdisplaymathend}

\BeforeBeginEnvironment{alignat}{\tightdisplaymath}
\AfterEndEnvironment{alignat}{\tightdisplaymathend}
\BeforeBeginEnvironment{alignat*}{\tightdisplaymath}
\AfterEndEnvironment{alignat*}{\tightdisplaymathend}

\BeforeBeginEnvironment{flalign}{\tightdisplaymath}
\AfterEndEnvironment{flalign}{\tightdisplaymathend}
\BeforeBeginEnvironment{flalign*}{\tightdisplaymath}
\AfterEndEnvironment{flalign*}{\tightdisplaymathend}

\BeforeBeginEnvironment{gather}{\tightdisplaymath}
\AfterEndEnvironment{gather}{\tightdisplaymathend}
\BeforeBeginEnvironment{gather*}{\tightdisplaymath}
\AfterEndEnvironment{gather*}{\tightdisplaymathend}

\BeforeBeginEnvironment{multline}{\tightdisplaymath}
\AfterEndEnvironment{multline}{\tightdisplaymathend}
\BeforeBeginEnvironment{multline*}{\tightdisplaymath}
\AfterEndEnvironment{multline*}{\tightdisplaymathend}

% Optional, only if you still use eqnarray anywhere:
\BeforeBeginEnvironment{eqnarray}{\tightdisplaymath}
\AfterEndEnvironment{eqnarray}{\tightdisplaymathend}
\BeforeBeginEnvironment{eqnarray*}{\tightdisplaymath}
\AfterEndEnvironment{eqnarray*}{\tightdisplaymathend}
