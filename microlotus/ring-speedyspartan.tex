...
\paragraph{Comparison with the matrix-vector approach.}
...
\paragraph{Degree reduction via intermediate commitments.}
...
\paragraph{Batching the CRT transform.}
...
\paragraph{Spark++ for ring matrices.}
...
\paragraph{Compatibility with folding.}
...
\paragraph{Extension to non-fully-split cyclotomics.}
