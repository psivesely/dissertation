...
\parhead{A CRT-domain sumcheck for ring arithmetic}
...
\parhead{Holographic variant and reduced sumcheck}
...
\parhead{Ring Plonkish SNARK example}
...
\parhead{Odd-prime tower fields}
...
\subsection{Microlotus PCS implementation}
\label{sec:microlotus}
